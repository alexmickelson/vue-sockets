...
export const socketCategory = new Category("socket");
// export const socketProd = new Category("product", socketService);

// Optionally get a logger for a category, since 0.5.0 this is not necessary anymore, you can use the category itself to log.
export const log: CategoryLogger = CategoryServiceFactory.getLogger(socketCategory);